...
impl Tool for SearchGithubIssuesAndPullRequestsTool {
    ...
    async fn definition(&self, _prompt: String) -> ToolDefinition {
        ToolDefinition {
            ...
            description: format!(
                "Search GitHub issues and pull requests inside the configured organization scope ({scope_org}). Every query must explicitly include org:{scope_org}.",
            ...
            parameters: json!({
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": format!("GitHub issues/PR search query. Always include org:{}.", self.github_scope_org)
                    },
                    "limit": {
                        "type": "integer",
                        "minimum": 1,
