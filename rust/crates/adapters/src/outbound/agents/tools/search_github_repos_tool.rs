...
impl Tool for SearchGithubReposTool {
    ...
    async fn definition(&self, _prompt: String) -> ToolDefinition {
        ToolDefinition {
            ...
            description:
                "Search GitHub repositories inside the configured organization scope. Every query must explicitly include org:<githubScopeOrg from runtime context>."
                    .to_string(),
            parameters: json!({
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "GitHub repository search query. Always include org:<githubScopeOrg from runtime context>."
                    },
                    "limit": {
                        "type": "integer",
                        "minimum": 1,
