...
const DEFAULT_INVESTIGATION_LEAD_MAX_TURNS: usize = 20;
...
pub struct LlmProviderSettings {
    ...
    pub investigation_lead_max_turns: usize,
...
pub fn create_openai_provider_settings(
    ...
    LlmProviderSettings {
        ...
        specialist_model: input.investigation_lead_model.clone(),
        investigation_lead_model: input.investigation_lead_model,
        investigation_lead_max_turns: DEFAULT_INVESTIGATION_LEAD_MAX_TURNS,
...
pub fn create_bedrock_provider_settings(
    ...
    LlmProviderSettings {
        ...
        investigation_lead_model: input.model_id,
        investigation_lead_max_turns: DEFAULT_INVESTIGATION_LEAD_MAX_TURNS,
        specialist_max_turns: DEFAULT_SPECIALIST_MAX_TURNS,
        tool_concurrency: DEFAULT_TOOL_CONCURRENCY,
        additional_params: json!({}),
